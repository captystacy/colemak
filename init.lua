...
local mappings = {
    -- Up/down/left/right
    { modes = { "n", "o", "x" }, lhs = "n", rhs = "h", desc = "Left (n)" },
    { modes = { "n", "o", "x" }, lhs = "e", rhs = "j", desc = "Down (e)" },
    { modes = { "n", "o", "x" }, lhs = ",", rhs = "5j", desc = "5x Down (,)" },
    { modes = { "n", "o", "x" }, lhs = "i", rhs = "k", desc = "Up (i)" },
    { modes = { "n", "o", "x" }, lhs = ".", rhs = "5k", desc = "5x Up (.)" },
    { modes = { "n", "o", "x" }, lhs = "o", rhs = "l", desc = "Right (o)" },
    ...
    { modes = { "n", "o", "x" }, lhs = "O", rhs = "w", desc = "Word forward" },
    { modes = { "n", "o", "v" }, lhs = "U", rhs = "B", desc = "WORD back" },
    { modes = { "n", "o", "v" }, lhs = "Y", rhs = "W", desc = "WORD forward" },

    -- End of word left/right
    { modes = { "n", "o", "x" }, lhs = "N", rhs = "ge", desc = "End of word back" },
    { modes = { "n", "o", "x" }, lhs = "<M-n>", rhs = "gE", desc = "End of WORD back" },
    { modes = { "n", "o", "x" }, lhs = "y", rhs = "e", desc = "End of word forward" },
    { modes = { "n", "o", "x" }, lhs = "<M-o>", rhs = "E", desc = "End of WORD forward" },
